...
[!WARNING]
Beta статус: Наразі функція працює у тестовому режимі. Зображення можуть завантажуватися з генерованими ID замість оригінальних назв, оскільки API Miro має обмеження на передачу метаданих.
